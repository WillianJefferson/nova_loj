<?php
	...
	$resultad = mysqli_query($conn, $result);
	//$id_produto = $resultado['id'];


	while ($resultado = mysqli_fetch_array($resultad)) {
			...
			<div class="col-sm-10">
			  <select class="form-control" name="categoria_id">
				  ...
				  <?php 
						...
						$resultad2 = mysqli_query($conn, $result_cat);

						while($dados = mysqli_fetch_array($resultad2)){
			...
			<div class="col-sm-10">
			  <select class="form-control" name="situacao_id">
				  ...
				  <?php 
						...
						$resultad3 = mysqli_query($conn, $result_sit);

						while($dados2 = mysqli_fetch_array($resultad3)){
							
							$id_situacao = $dados2['id'];
							?>
