			...
			<ul class="nav navbar-nav">            
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="administrativo.php?link=10">Listar Serviços</a></li>     
						<li><a href="administrativo.php?link=22">Serviços Destaque</a></li> 		
						<li><a href="administrativo.php?link=23">Destacar Serviços </a></li>
					</ul>
				</li>
				<li class="dropdown">
