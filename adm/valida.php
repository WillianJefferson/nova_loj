...
if((isset($_POST['login'])) && (isset($_POST['senha']))){
		...
		$result_usuario = "SELECT * FROM usuarios WHERE usu_login = '$login' && usu_senha = '$senha' LIMIT 1";
		...
		if(isset($resultado)){
			...
			$_SESSION['usuarioNiveisAcessoId'] = $resultado['usu_nivel'];
			$_SESSION['usuarioEmail'] = $resultado['usu_email'];
			$_SESSION['usuarioLogin'] = $resultado['usu_login'];
			$_SESSION['usuarioCnpj'] = $resultado['usu_cnpj'];
