        ...
        <div class="col-md-12">
            ...
            <form class="form-horizontal" method="POST" action="processa/proc_cad_empresa.php">
                <h4 class="col-sm-12 col-lg-12 col-md-12 text-primary">
                    <i class="glyphicon glyphicon-list-alt"></i> Dados Gerais
                </h4>
                ...
                <h4 class="col-sm-12 col-lg-12 col-md-12 text-primary">
                    <i class="glyphicon glyphicon-map-marker margin-right-5px">
                    </i> Endereço
                </h4>
                ...
                <div class="required form-group col-sm-4 col-lg-4 col-md-4">
                    ...
                    <input name="data[Loja][cidade_id]" class="cidade form-control" autocomplete="off" type="text" id="LojaCidadeId" style="display: none;">
                </div>
                ...
                <div class="both col-sm-12 col-lg-12 col-md-12 margin-top-10px">
                    <button class="btn btn-success btn-responsive" type="submit">
                        <span class="glyphicon glyphicon-ok margin-right-10px">
                        </span> Cadastrar
                    </button>                    
                    <a href="#" class="btn btn-danger btn-responsive">
                        <span class="glyphicon glyphicon-remove margin-right-10px">
                        </span> Cancelar
                    </a>                
                </div>
